...
const HeroSection = () => {
  ...
  const roles = ["Frontend Developer", "React Specialist", "MERN Developer"];
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl lg:ml-80 px-4 py-24 lg:py-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* <motion.button
            className="px-8 py-4 bg-gray-800/50 backdrop-blur-sm border border-gray-700 text-white rounded-full font-semibold hover:bg-gray-700/50 transition-all duration-300 flex items-center space-x-2"
            whileHover={{ scale: 1.05, y: -2 }}
            whileTap={{ scale: 0.95 }}
          >
