              ...
              >
                <div className="w-full h-full rounded-full overflow-hidden bg-gray-900">
                  <img
                    src={image1}
                    alt="Lakshmi Priyan"
                    className="w-full h-full object-cover object-[center_9%]" // Adjusts focus higher
                  />
                </div>
              </motion.div>
            ...
            {navItems.map((item, index) => {
              ...
              return (
                <motion.button
                  ...
                  className={`w-full group relative flex items-center space-x-4 p-4 rounded-xl transition-all duration-300 ${
                    isActive
                  ...
                  {navItems.map((item, index) => {
                    ...
                    return (
                      <motion.button
                        key={item.id}
                        onClick={() => scrollToSection(item.href, item.id)}
                        className={`w-full group relative flex items-center space-x-3 p-3 rounded-lg transition-all duration-300 ${
                          isActive
                            ? "bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 text-cyan-400"
                            : "text-gray-300 hover:bg-gray-800/50 hover:text-white"
                        }`}
